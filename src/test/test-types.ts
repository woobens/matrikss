...
test.each([
  ...
  ["Email", "woobens@gmail.com", { type: "Email" }, "woobens@gmail.com"],
  ["Domain", "woobens.com", { type: "Domain" }, "woobens.com"],
  ["Alpha", "Woobens", { type: "Alpha" }, "Woobens"],
  ["AlphaNumeric", "Woobens012", { type: "AlphaNumeric" }, "Woobens012"],
  ["Ascii", "Woobens.com/hello", { type: "Ascii" }, "Woobens.com/hello"],
  ["Base64", "WW91cnRpb24=", { type: "Base64" }, "WW91cnRpb24="],
  ["URL", "http://github.com/woobens", { type: "URL" }, "http://github.com/woobens"],
...
test.each([
  ...
  ["Integer", "Woobens", { type: "ENUM", params: ["Hello", "World"] }],
  ["ENUM", "Woobens", { type: "ENUM", params: ["Hello", "World"] }],
